...
const MoviePage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#070913] text-white pt-34 pb-16">
      ...
      <div className="relative z-10 w-11/12 lg:max-w-7xl mx-auto">
        <div data-aos="fade-down" className="max-w-2xl mx-auto mb-10">
          <div className="relative flex items-center">
            ...
            <input
              ...
              className="w-full h-12 bg-slate-900/80 border border-white/10 rounded-sm pl-12 pr-11 text-sm text-white placeholder-slate-400 focus:outline-none focus:border-red-500 focus:bg-slate-900 transition-all shadow-xl shadow-black/40"
            />
            {searchQuery && (
              <button
        ...
        {loading ? (
          ...
          <div
            data-aos="zoom-in"
            className="text-center py-20 bg-white/5 rounded-xl border border-white/5"
          >
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-4 gap-4 sm:gap-6">
              {currentMovies.map((movie, index) => (
                <div
                  ...
                  className="group relative bg-slate-900/60 rounded-md overflow-hidden border border-white/10 hover:border-red-500/50 transition-all duration-300 hover:shadow-xl hover:shadow-red-950/40 flex flex-col justify-between"
                >
            ...
            {totalPages > 1 && (
              ...
              >
                <button
                  ...
                  className="p-2.5 rounded-sm bg-slate-900 border border-white/10 text-slate-400 hover:text-white hover:border-red-500 disabled:opacity-40 disabled:hover:border-white/10 transition cursor-pointer"
                >
                    ...
                    <button
                      ...
                      className={`w-9 h-9 text-xs font-bold rounded-sm border transition cursor-pointer ${
                        currentPage === number
                          ...
                          : "bg-slate-900 border-white/10 text-slate-300 hover:border-red-500 hover:text-white"
                      }`}
                    >
                      {number}
                    </button>
